...
import org.java.plus.dag.core.base.mvel2.ParserConfiguration;
...
import static org.java.plus.dag.core.base.mvel2.PropertyAccessor.get;
...
public class ASTNode implements Cloneable, Serializable {
    ...
    private Object optimize(Object ctx, Object thisValue, VariableResolverFactory factory) {
        ...
        try {
            ...
            setAccessor(
                optimizer.optimizeAccessor(pCtx, expr, start, offset, ctx, thisValue, factory, true, egressType));
    ...
    private int getAbsoluteFirstPart() {
        if ((fields & COLLECTION) != 0) {
            if (firstUnion < 0 || endOfName < firstUnion) { return endOfName; } else { return firstUnion; }
