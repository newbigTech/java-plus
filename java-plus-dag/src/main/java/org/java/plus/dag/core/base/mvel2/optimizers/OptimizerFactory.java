...
import org.java.plus.dag.core.base.mvel2.optimizers.dynamic.DynamicOptimizer;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.asm.ASMAccessorOptimizer;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl
...
public class OptimizerFactory {
    ...
    static {
        ...
        try {
            if (OptimizerFactory.class.getClassLoader() != null) {
                OptimizerFactory.class.getClassLoader().loadClass(
                    "org.java.plus.dag.core.base.mvel2.asm.ClassWriter");
            } else {
        ...
        if (Boolean.getBoolean("mvel2.disable.jit")) { setDefaultOptimizer(SAFE_REFLECTIVE); } else {
    ...
    public static void setDefaultOptimizer(String name) {
        try {
            ...
            ao.init();
            //clear optimizer so next call to getThreadAccessorOptimizer uses the default again, don't set thread
            // optimizer
