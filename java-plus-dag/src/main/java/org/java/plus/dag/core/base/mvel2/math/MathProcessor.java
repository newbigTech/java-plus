 ...
 */
package org.java.plus.dag.core.base.mvel2.math;

import org.java.plus.dag.core.base.mvel2.DataTypes;
import org.java.plus.dag.core.base.mvel2.Unit;
import org.java.plus.dag.core.base.mvel2.compiler.BlankLiteral;
import org.java.plus.dag.core.base.mvel2.debug.DebugTools;
import org.java.plus.dag.core.base.mvel2.util.InternalNumber;
...
import static org.java.plus.dag.core.base.mvel2.DataTypes.BIG_DECIMAL;
import static org.java.plus.dag.core.base.mvel2.DataTypes.EMPTY;
...
import static org.java.plus.dag.core.base.mvel2.Operator.BW_NOT;
...
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.__resolveType;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isNumber;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.narrowType;
...
public class MathProcessor {
    ...
    public strictfp static Object doOperations(Object val1, int operation, Object val2) {
    ...
    public strictfp static Object doOperations(Object val1, int operation, int type2, Object val2) {
        return doOperations(val1 == null ? DataTypes.OBJECT : __resolveType(val1.getClass()), val1, operation, type2,
            val2);
    }

    public strictfp static Object doOperations(int type1, Object val1, int operation, int type2, Object val2) {
    ...
    private strictfp static Object doPrimWrapperArithmetic(final Number val1, final int operation, final Number val2,
                                                           boolean iNumber, int returnTarget) {
        switch (operation) {
            case ADD:
    ...
    private strictfp static Object toType(Number val, int returnType) {
        switch (returnType) {
    ...
    private strictfp static Object doBigDecimalArithmetic(final BigDecimal val1, final int operation,
                                                          final BigDecimal val2, boolean iNumber, int returnTarget) {
        switch (operation) {
            case ADD:
                if (iNumber) {
    ...
    private strictfp static Object _doOperations(int type1, Object val1, int operation, int type2, Object val2) {
        if (operation < 20) {
    ...
    private strictfp static boolean isNumericOperation(int type1, Object val1, int operation, int type2, Object val2) {
        return (type1 > 99 && type2 > 99)
            || (operation != ADD && (type1 > 99 || type2 > 99 || operation < LTHAN || operation > GETHAN) && isNumber(
            val1) && isNumber(val2));
    }

    private strictfp static boolean isIntegerType(int type) {
        return type == DataTypes.INTEGER || type == DataTypes.W_INTEGER || type == DataTypes.LONG
            || type == DataTypes.W_LONG;
    }

    private strictfp static Object doOperationNonNumeric(int type1, final Object val1, final int operation,
                                                         final Object val2) {
        switch (operation) {
            case ADD:
    ...
    private strictfp static Boolean safeEquals(final Object val1, final Object val2) {
        if (val1 != null) {
            return val1.equals(val2) ? Boolean.TRUE : Boolean.FALSE;
        } else { return val2 == null || (val2.equals(val1) ? Boolean.TRUE : Boolean.FALSE); }
    }

    private strictfp static Boolean safeNotEquals(final Object val1, final Object val2) {
        if (val1 != null) {
            return !val1.equals(val2) ? Boolean.TRUE : Boolean.FALSE;
        } else { return (val2 != null && !val2.equals(val1)) ? Boolean.TRUE : Boolean.FALSE; }
    }

    private strictfp static Object doOperationsSameType(int type1, Object val1, int operation, Object val2) {
        switch (type1) {
            ...
            case DataTypes.W_INTEGER:
                switch (operation) {
                    ...
                    case POWER:
                        ...
                        if (d > Integer.MAX_VALUE) { return d; } else { return (int)d; }
                    case MOD:
                        return ((Integer)val1) % ((Integer)val2);
                    case GTHAN:
            ...
            case DataTypes.W_SHORT:
                switch (operation) {
                    ...
                    case POWER:
                        ...
                        if (d > Short.MAX_VALUE) { return d; } else { return (short)d; }
                    case MOD:
                        return ((Short)val1) % ((Short)val2);
                    case GTHAN:
            ...
            case DataTypes.W_LONG:
                switch (operation) {
                    ...
                    case POWER:
                        ...
                        if (d > Long.MAX_VALUE) { return d; } else { return (long)d; }
                    case MOD:
                        return ((Long)val1) % ((Long)val2);
                    case GTHAN:
    ...
    private strictfp static int box(int type) {
        switch (type) {
            case DataTypes.INTEGER:
    ...
    private strictfp static Double getNumber(Object in, int type) {
    ...
    private strictfp static InternalNumber getInternalNumberFromType(Object in, int type) {
