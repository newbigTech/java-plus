...
package org.java.plus.dag.core.base.mvel2.templates;

import org.java.plus.dag.core.base.mvel2.CompileException;
import org.java.plus.dag.core.base.mvel2.ParserContext;
import org.java.plus.dag.core.base.mvel2.templates.res.CodeNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CommentNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledCodeNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledDeclareNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledEvalNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledExpressionNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledForEachNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledIfNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledIncludeNode;
import org.java.plus.dag.core.base.mvel2.templates.res.CompiledNamedIncludeNode;
import org.java.plus.dag.core.base.mvel2.templates.res
    .CompiledTerminalExpressionNode;
import org.java.plus.dag.core.base.mvel2.templates.res.DeclareNode;
import org.java.plus.dag.core.base.mvel2.templates.res.EndNode;
import org.java.plus.dag.core.base.mvel2.templates.res.EvalNode;
import org.java.plus.dag.core.base.mvel2.templates.res.ExpressionNode;
import org.java.plus.dag.core.base.mvel2.templates.res.ForEachNode;
import org.java.plus.dag.core.base.mvel2.templates.res.IfNode;
import org.java.plus.dag.core.base.mvel2.templates.res.IncludeNode;
import org.java.plus.dag.core.base.mvel2.templates.res.NamedIncludeNode;
import org.java.plus.dag.core.base.mvel2.templates.res.Node;
import org.java.plus.dag.core.base.mvel2.templates.res.Opcodes;
import org.java.plus.dag.core.base.mvel2.templates.res.TerminalExpressionNode;
import org.java.plus.dag.core.base.mvel2.templates.res.TerminalNode;
import org.java.plus.dag.core.base.mvel2.templates.res.TextNode;
import org.java.plus.dag.core.base.mvel2.templates.util.TemplateTools;
...
public class TemplateCompiler {
    ...
    public Node compileFrom(Node root, ExecutionStack stack) {
        ...
        try {
                            ...
                            switch ((opcode = OPCODES.get(name = new String(capture()))) == null ? 0 : opcode) {
                                ...
                                case Opcodes.INCLUDE_FILE:
                                    n = markTextNode(n).next =
                                        codeCache ? new CompiledIncludeNode(start, name, template, captureOrbInternal(),
                                ...
                                case Opcodes.EVAL:
                                    n = markTextNode(n).next =
                                        codeCache ? new CompiledEvalNode(start, name, template, captureOrbInternal(),
                                            start = cursor + 1, parserContext)
                                ...
                                case Opcodes.END:
                                    ...
                                    if (end.demarcate(terminal, template)) { n = n.next = terminal; } else {
                                        n = terminal;
                                    }
                                    ...
                                    if (name.length() == 0) {
                                        ...
                                        try {
                                            ...
                                            throw new RuntimeException(
                                                "unable to instantiate custom node class: " + customNode.getName());
            ...
            if (e instanceof CompileException) {
                ...
                if (ce2.getCursor() != -1) {
                    ...
                    if (ce2.getColumn() == -1) { ce.setColumn(ce.getCursor() - colStart); } else {
        ...
        if (!stack.isEmpty()) {
            CompileException ce = new CompileException(
                "unclosed @" + ((Node)stack.peek()).getName() + "{} block. expected @end{}", template, cursor);
    ...
    public static CompiledTemplate compileTemplate(InputStream stream, Map<String, Class<? extends Node>> customNodes) {
        return new TemplateCompiler(TemplateTools.readStream(stream), customNodes, true, ParserContext.create())
            .compile();
    }
    ...
    public static CompiledTemplate compileTemplate(File file, Map<String, Class<? extends Node>> customNodes) {
        return new TemplateCompiler(TemplateTools.readInFile(file), customNodes, true, ParserContext.create())
            .compile();
    }
