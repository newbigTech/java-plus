 ...
 */
package org.java.plus.dag.core.base.mvel2.optimizers.impl.asm;

import org.java.plus.dag.core.base.mvel2.CompileException;
import org.java.plus.dag.core.base.mvel2.DataConversion;
import org.java.plus.dag.core.base.mvel2.MVEL;
import org.java.plus.dag.core.base.mvel2.OptimizationFailure;
import org.java.plus.dag.core.base.mvel2.ParserContext;
import org.java.plus.dag.core.base.mvel2.PropertyAccessException;
import org.java.plus.dag.core.base.mvel2.asm.ClassWriter;
import org.java.plus.dag.core.base.mvel2.asm.Label;
import org.java.plus.dag.core.base.mvel2.asm.MethodVisitor;
import org.java.plus.dag.core.base.mvel2.asm.Opcodes;
import org.java.plus.dag.core.base.mvel2.ast.FunctionInstance;
...
import org.java.plus.dag.core.base.mvel2.compiler.ExecutableAccessor;
import org.java.plus.dag.core.base.mvel2.compiler.ExecutableLiteral;
import org.java.plus.dag.core.base.mvel2.compiler.ExecutableStatement;
import org.java.plus.dag.core.base.mvel2.compiler.PropertyVerifier;
import org.java.plus.dag.core.base.mvel2.integration.GlobalListenerFactory;
import org.java.plus.dag.core.base.mvel2.integration.PropertyHandler;
import org.java.plus.dag.core.base.mvel2.integration.VariableResolverFactory;
import org.java.plus.dag.core.base.mvel2.optimizers.AbstractOptimizer;
import org.java.plus.dag.core.base.mvel2.optimizers.AccessorOptimizer;
import org.java.plus.dag.core.base.mvel2.optimizers.OptimizationNotSupported;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.Union;
import org.java.plus.dag.core.base.mvel2.util.JITClassLoader;
import org.java.plus.dag.core.base.mvel2.util.MVELClassLoader;
import org.java.plus.dag.core.base.mvel2.util.MethodStub;
import org.java.plus.dag.core.base.mvel2.util.ParseTools;
import org.java.plus.dag.core.base.mvel2.util.PropertyTools;
...
import static org.java.plus.dag.core.base.mvel2.DataConversion.canConvert;
import static org.java.plus.dag.core.base.mvel2.DataConversion.convert;
import static org.java.plus.dag.core.base.mvel2.MVEL.eval;
import static org.java.plus.dag.core.base.mvel2.MVEL.isAdvancedDebugging;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.AALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.AASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ACC_PRIVATE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ACC_PUBLIC;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ACONST_NULL;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ANEWARRAY;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ARETURN;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ARRAYLENGTH;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ATHROW;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.BALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.BASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.BIPUSH;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.CALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.CASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.CHECKCAST;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.DALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.DASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.DUP;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.DUP_X1;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.DUP_X2;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.FALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.FASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.GETFIELD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.GETSTATIC;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.GOTO;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.IALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.IASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ICONST_0;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ICONST_1;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ICONST_2;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ICONST_3;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ICONST_4;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ICONST_5;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.IFEQ;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.IFNONNULL;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.IF_ICMPLT;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ILOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.INVOKEINTERFACE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.INVOKESPECIAL;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.INVOKESTATIC;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.INVOKEVIRTUAL;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.ISTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.LALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.LASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.NEW;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.POP;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.PUTFIELD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.RETURN;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.SALOAD;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.SASTORE;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.SIPUSH;
import static org.java.plus.dag.core.base.mvel2.asm.Opcodes.SWAP;
import static org.java.plus.dag.core.base.mvel2.asm.Type.getConstructorDescriptor;
import static org.java.plus.dag.core.base.mvel2.asm.Type.getDescriptor;
import static org.java.plus.dag.core.base.mvel2.asm.Type.getInternalName;
import static org.java.plus.dag.core.base.mvel2.asm.Type.getMethodDescriptor;
import static org.java.plus.dag.core.base.mvel2.asm.Type.getType;
import static org.java.plus.dag.core.base.mvel2.ast.TypeDescriptor.getClassReference;
import static org.java.plus.dag.core.base.mvel2.integration.GlobalListenerFactory
    .hasGetListeners;
import static org.java.plus.dag.core.base.mvel2.integration.GlobalListenerFactory
    .notifyGetListeners;
import static org.java.plus.dag.core.base.mvel2.integration.PropertyHandlerFactory
...
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.EMPTY_OBJ_ARR;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.balancedCapture;
...
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.findClass;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.getBaseComponentType;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.getBestCandidate;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools
    .getBestConstructorCandidate;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.getSubComponentType;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.getWidenedTarget;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isPrimitiveWrapper;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools
    .parseMethodOrConstructor;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.parseParameterList;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.repeatChar;
...
import static org.java.plus.dag.core.base.mvel2.util.PropertyTools
    .getFieldOrAccessor;
import static org.java.plus.dag.core.base.mvel2.util.PropertyTools
    .getFieldOrWriteAccessor;
import static org.java.plus.dag.core.base.mvel2.util.ReflectionUtil
    .toNonPrimitiveArray;
import static org.java.plus.dag.core.base.mvel2.util.ReflectionUtil
    .toNonPrimitiveType;
import static org.java.plus.dag.core.base.mvel2.util.Varargs.normalizeArgsForVarArgs;
import static org.java.plus.dag.core.base.mvel2.util.Varargs.paramTypeVarArgsSafe;
...
public class ASMAccessorOptimizer extends AbstractOptimizer implements AccessorOptimizer {
    ...
    static {
        ...
        if (defaultNameSapce == null) { NAMESPACE = "org/mvel2/"; } else { NAMESPACE = defaultNameSapce; }

        String jitListImpl = getProperty("mvel2.jit.list_impl");
        if (jitListImpl == null) { LIST_IMPL = NAMESPACE + "util/FastList"; } else { LIST_IMPL = jitListImpl; }
    }
            ...
            if (collection) {
                ...
                if (ctx instanceof Map) {
                    ...
                    if (MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING && hasPropertyHandler(Array.class)) {
                        ...
                        if (type.isPrimitive()) { unwrapPrimitive(type); } else if (!type.equals(value.getClass())) {
                            dataConversion(type);
                        }
            ...
            if (member instanceof Field) {
                ...
                if (value != null && !targetType.isAssignableFrom(value.getClass())) {
                    ...
                    if (targetType.isPrimitive()) {
                        ...
                        assert debug(
                            "INVOKEVIRTUAL " + getInternalName(meth.getDeclaringClass()) + "." + meth.getName());
    ...
    private void _finishJIT() {
        ...
        if (propNull) {
            cw.visitField(ACC_PUBLIC, "nullPropertyHandler", "L" + NAMESPACE + "integration/PropertyHandler;", null,
                null).visitEnd();
        }

        if (methNull) {
            cw.visitField(ACC_PUBLIC, "nullMethodHandler", "L" + NAMESPACE + "integration/PropertyHandler;", null, null)
                .visitEnd();
        }
    ...
    private void visitConstantClass(Class<?> clazz) {
        ...
        if (clazz.isPrimitive()) {
            mv.visitFieldInsn(GETSTATIC, toNonPrimitiveType(clazz).getName().replace(".", "/"), "TYPE",
                "Ljava/lang/Class;");
        } else {
            mv.visitLdcInsn(
                org.java.plus.dag.core.base.mvel2.asm.Type.getType(clazz));
        }
    }
    ...
    private Accessor _initializeAccessor() throws Exception {
        ...
        try {
            if (compiledInputs.size() == 0) {
                ...
                ExecutableStatement[] array = compiledInputs.toArray(new ExecutableStatement[compiledInputs.size()]);
                o = ConstructorUtils.invokeConstructor(cls, array, parms);
            }
    ...
    private Object getWithProperty(Object ctx) {
        ...
        for (WithNode.ParmValuePair aPvp : WithNode.compileWithExpressions(expr, start, cursor++ - start, root,
            ingressType, pCtx)) {
            assert debug("DUP");
            mv.visitInsn(DUP);
    ...
    private Object getBeanProperty(Object ctx, String property)
        ...
        if (member instanceof Field) {
            ...
            try {
                ...
                if (iFaceMeth == null) {
                    throw new PropertyAccessException("could not access field: " + cls.getName() + "." + property, expr,
                        st, e, pCtx);
                }
    ...
    private Object optimizeFieldMethodProperty(Object ctx, String property, Class<?> cls, Member member)
        ...
        if (((member.getModifiers() & STATIC) != 0)) {
            ...
            if ((member.getModifiers() & FINAL) != 0 && (o instanceof String || ((Field)member).getType()
                .isPrimitive())) {
    ...
    private Object getMethod(Object ctx, String name)
        ...
        // If we didn't find anything and the declared class is different from the actual one try also with the
        // actual one
        ...
        if (es != null && m != null && m.isVarArgs() && (es.length != parameterTypes.length || !(es[es.length
            - 1] instanceof ExecutableAccessor))) {
            ...
            if (m.getParameterTypes().length == 0) {
                ...
                if (m.isVarArgs()) {
                    if (es == null || es.length == (m.getParameterTypes().length - 1)) {
                        ExecutableStatement[] executableStatements = new ExecutableStatement[m
                            .getParameterTypes().length];
                        if (es != null) {
                            System.arraycopy(es, 0, executableStatements, 0, es.length);
                        }
                        executableStatements[executableStatements.length - 1] = new ExecutableLiteral(
                            Array.newInstance(aClass, 0));
                ...
                for (int i = 0; es != null && i < es.length; i++) {
                    ...
                    mv.visitFieldInsn(GETFIELD, className, "p" + inputsOffset,
                    ...
                    if (parameterTypes[i].isPrimitive()) {
                        ...
                        assert debug(
                            "<<<OPT. JUSTIFICATION " + parameterTypes[i] + "=" + preConvArgs[i].getClass() + ">>>");
    ...
    private void buildInputs() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            cw.visitField(ACC_PRIVATE, "p" + i, "L" + NAMESPACE + "compiler/ExecutableStatement;", null, null)
                .visitEnd();
    ...
    private int _getAccessor(Object o, Class type) {
        if (o instanceof List) {
            ...
            try {
                ...
                assert debug(
                    "ANEWARRAY " + getInternalName(getSubComponentType(type)) + " (" + ((Object[])o).length + ")");
    ...
    public Accessor optimizeObjectCreation(ParserContext pCtx, char[] property, int start, int offset, Object ctx,
        ...
        try {
            if (constructorParms != null) {
                ...
                Class cls = findClass(factory, new String(subset(property, 0, findFirst('(', start, length, property))),
                    pCtx);
    ...
    private void writeOutNullHandler(Member member, int type) {
        ...
        if (type == 0) {
            ...
            mv.visitFieldInsn(GETFIELD, className, "nullPropertyHandler",
                "L" + NAMESPACE + "integration/PropertyHandler;");
        } else {
            this.methNull = true;

            assert debug("GETFIELD 'nullMethodHandler'");
            mv.visitFieldInsn(GETFIELD, className, "nullMethodHandler",
                "L" + NAMESPACE + "integration/PropertyHandler;");
        }
