...
import static org.java.plus.dag.core.base.mvel2.util.PropertyTools.getReturnType;
...
public class WithNode extends BlockNode implements NestedStatement {
    ...
    public static ParmValuePair[] compileWithExpressions(char[] block, int start, int offset, String nestParm,
                                                         Class egressType, ParserContext pCtx) {
        /**
         *
