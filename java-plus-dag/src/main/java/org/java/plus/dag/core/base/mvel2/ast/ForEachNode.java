...
import org.java.plus.dag.core.base.mvel2.integration.impl.ItemResolverFactory;
...
public class ForEachNode extends BlockNode {
    ...
    public ForEachNode(char[] expr, int start, int offset, int blockStart, int blockOffset, int fields,
                       ParserContext pCtx) {
        super(pCtx);
    ...
    public Object getReducedValueAccelerated(Object ctx, Object thisValue, VariableResolverFactory factory) {
        ...
        ItemResolverFactory itemFactory = new ItemResolverFactory(itemR,
    ...
    private void handleCond(char[] condition, int start, int offset, int fields, ParserContext pCtx) {
        ...
        if ((fields & COMPILE_IMMEDIATE) != 0) {
            Class egress = (this.condition = (ExecutableStatement)subCompileExpression(expr, this.start, this.offset,
