...
import org.java.plus.dag.core.base.mvel2.MVELInterpretedRuntime;
...
import static org.java.plus.dag.core.base.mvel2.MVEL.compileSetExpression;
import static org.java.plus.dag.core.base.mvel2.util.ArrayTools.findFirst;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.checkNameSafety;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.createStringTrimmed;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.find;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.skipWhitespace;
...
public class AssignmentNode extends ASTNode implements Assignment {
    ...
    public AssignmentNode(char[] expr, int start, int offset, int fields, ParserContext pCtx) {
        ...
        if ((assignStart = find(expr, start, offset, '=')) != -1) {
            ...
            if (col = ((endOfName = findFirst('[', 0, this.varName.length(), indexTarget = this.varName.toCharArray()))
                > 0)) {
    ...
    public Object getReducedValueAccelerated(Object ctx, Object thisValue, VariableResolverFactory factory) {
        ...
        if (col) {
            ...
            if (factory == null) {
                throw new CompileException("cannot assign variables; no variable resolver factory available", expr,
                    start);
            }
    ...
    public Object getReducedValue(Object ctx, Object thisValue, VariableResolverFactory factory) {
        ...
        if (col) {
            PropertyAccessor.set(factory.getVariableResolver(varName).getValue(), factory, index, ctx = runtime.parse(),
                pCtx);
        } else {
