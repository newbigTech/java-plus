...
import org.java.plus.dag.core.base.mvel2.templates.CompiledTemplate;
import org.java.plus.dag.core.base.mvel2.templates.TemplateError;
...
import static org.java.plus.dag.core.base.mvel2.templates.util.TemplateTools
    .captureToEOS;
...
public class CompiledNamedIncludeNode extends Node {
    ...
    public CompiledNamedIncludeNode(int begin, String name, char[] template, int start, int end,
    ...
    public Object eval(TemplateRuntime runtime, TemplateOutputStream appender, Object ctx,
        ...
        if (next != null) {
            ...
            return next.eval(runtime, appender
                    .append(String.valueOf(TemplateRuntime.execute(ct, ctx, factory, runtime.getNamedTemplateRegistry
                        ()))),
                ctx, factory);

            //            return next.eval(runtime,
            //                    appender.append(String.valueOf(TemplateRuntime.execute(runtime
            // .getNamedTemplateRegistry().getNamedTemplate(MVEL.executeExpression(cIncludeExpression, ctx, factory,
            // String.class)), ctx, factory))), ctx, factory);
        } else {
            return appender.append(String.valueOf(TemplateRuntime.execute(runtime.getNamedTemplateRegistry()
                    .getNamedTemplate(MVEL.executeExpression(cIncludeExpression, ctx, factory, String.class)), ctx, factory,
