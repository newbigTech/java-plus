...
import static org.java.plus.dag.core.base.mvel2.MVEL.getProperty;
...
public class GetterAccessor implements AccessorNode {
        ...
        try {
            ...
            if (ctx == null) {
                throw new RuntimeException(
                    "unable to invoke method: " + method.getDeclaringClass().getName() + "." + method.getName() + ": " +
    ...
    public Object setValue(Object ctx, Object elCtx, VariableResolverFactory vars, Object value) {
        try {
            ...
            if (nextNode != null) {
                return nextNode.setValue(getProperty(getPropertyFromAccessor(method.getName()), ctx), elCtx, vars,
                    value);
            } else {
                return getProperty(getPropertyFromAccessor(method.getName()), ctx);
            }
            ...
            throw new RuntimeException(
                "error " + method.getName() + ": " + e.getClass().getName() + ":" + e.getMessage(), e);
        }
    }
