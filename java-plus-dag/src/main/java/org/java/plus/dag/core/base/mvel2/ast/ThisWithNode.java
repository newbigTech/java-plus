...
import static org.java.plus.dag.core.base.mvel2.MVEL.executeSetExpression;
...
public class ThisWithNode extends WithNode {
    ...
    public ThisWithNode(char[] expr, int start, int offset, int blockStart, int blockOffset, int fields,
                        ParserContext pCtx) {
