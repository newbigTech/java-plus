...
import org.java.plus.dag.core.base.mvel2.integration.impl.StackResetResolverFactory;
...
public class CompiledExpression implements Serializable, ExecutableStatement {
    ...
    public CompiledExpression(ASTLinkedList astMap, String sourceName, Class egressType,
                              ParserConfiguration parserConfiguration, boolean literalOnly) {
    ...
    public Object getDirectValue(Object staticContext, VariableResolverFactory factory) {
        return execute(false, this, staticContext,
            importInjectionRequired ? new ClassImportResolverFactory(parserConfiguration, factory, true)
