...
import org.java.plus.dag.core.base.mvel2.templates.SimpleTemplateRegistry;
...
public class CompiledDeclareNode extends Node {
    ...
    public CompiledDeclareNode(int begin, String name, char[] template, int start, int end, ParserContext context) {
        ...
        //  ce = MVEL.compileExpression(this.contents = subset(template, this.cStart = start, (this.end = this.cEnd =
        // end) - start - 1), context);
    }
