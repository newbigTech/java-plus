...
public class DynamicCollectionAccessor implements DynamicAccessor {
    ...
    public DynamicCollectionAccessor(ParserContext pCtx, Object rootObject, Class colType, char[] property, int start,
                                     int offset, int type, Accessor _accessor) {
        this.pCtx = pCtx;
    ...
    private Object optimize(ParserContext pCtx, Object ctx, Object elCtx,
