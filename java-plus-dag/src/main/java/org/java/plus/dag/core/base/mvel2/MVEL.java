...
import org.java.plus.dag.core.base.mvel2.compiler.CompiledAccExpression;
...
import org.java.plus.dag.core.base.mvel2.integration.Interceptor;
...
import static org.java.plus.dag.core.base.mvel2.MVELRuntime.execute;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.loadFromFile;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.optimizeTree;
...
public class MVEL {
     ...
     * @param resolverFactory The instance of the VariableResolverFactory to be used.
     * @return The resultant value
     * @see #eval(String, org.java.plus.dag.core.base.mvel2.integration
     ...
     * type if necessary. This is a wrapper convenience method which wraps the provided Map of vars in a{@link
    ...
    public static <T> T eval(char[] expression, int start, int offset, Object ctx, VariableResolverFactory vars,
                             Class<T> toType) {
    ...
    public static Object evalFile(File file, String encoding, Object ctx, VariableResolverFactory vars) throws
        IOException {
    ...
    private static Object _evalFile(File file, String encoding, Object ctx, VariableResolverFactory factory)
        throws IOException {
    ...
    /**
     * Performs an analysis compileShared, which will populate the ParserContext with type, input and variable
     * information,
     ...
     * improves performance as re-parsing of the expression is not required, and the runtime can dynamically
     * compileShared
     ...
     * imports.put("time", MVEL.getStaticMethod(System.class, "currentTimeMillis", new Class[0])); // import a static
     * method
     * <p/>
     * // Compile the expression
     ...
     * value.<br/>{@link org.java.plus.dag.core.base.mvel2.integration.Interceptor
     ...
     */
    public static Serializable compileExpression(String expression, Map<String, Object> imports, Map<String,
    ...
    public static Serializable compileExpression(String expression, Map<String, Object> imports, Map<String,
        Interceptor> interceptors, String sourceName) {
    ...
    public static Serializable compileExpression(char[] expression, Map<String, Object> imports, Map<String,
        Interceptor> interceptors) {
        return compileExpression(expression, imports, interceptors, null);
    }
    ...
    public static void executeSetExpression(Serializable compiledSet, Object ctx, VariableResolverFactory vrf,
                                            Object value) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T executeExpression(final Object compiledExpression, final Object ctx, final Map vars, Class<T>
        toType) {
    ...
    public static <T> T executeExpression(final Object compiledExpression, final Object ctx,
                                          final VariableResolverFactory vars, Class<T> toType) {
        return convert(executeExpression(compiledExpression, ctx, vars), toType);
    }
    ...
    public static Object[] executeAllExpression(Serializable[] compiledExpressions, Object ctx,
                                                VariableResolverFactory vars) {
