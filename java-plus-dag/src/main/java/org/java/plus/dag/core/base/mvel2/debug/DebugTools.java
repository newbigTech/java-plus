...
package org.java.plus.dag.core.base.mvel2.debug;
...
import org.java.plus.dag.core.base.mvel2.ast.NestedStatement;
...
import org.java.plus.dag.core.base.mvel2.util.ASTIterator;
...
public class DebugTools {
    ...
    public static String decompile(Serializable expr) {
        if (expr instanceof CompiledExpression) {
            return decompile((CompiledExpression)expr);
    ...
    private static String decompile(CompiledExpression cExp, boolean nest, DecompileContext context) {
        ...
        while (iter.hasMoreNodes()) {
            ...
            //                        .append(decompile((CompiledExpression) ((Function)tk).getCompiledBlock(), true,
            // context));
            //            }
