...
import org.java.plus.dag.core.base.mvel2.templates.TemplateRuntimeError;
import org.java.plus.dag.core.base.mvel2.templates.util.ArrayIterator;
import org.java.plus.dag.core.base.mvel2.templates.util.CountIterator;
    ...
    private void configure() {
        ...
        for (int i = start; i < cEnd; i++) {
            switch (contents[i]) {
                ...
                //                    }
                //                    else {
                //                        throw new CompileException("unexpected character '" + contents[i] + "' in
                // foreach tag", contents,cStart + 1);
                //                    }
                //                    break;
