...
import org.java.plus.dag.core.base.mvel2.ScriptRuntimeException;
import org.java.plus.dag.core.base.mvel2.integration.VariableResolverFactory;
import org.java.plus.dag.core.base.mvel2.util.CompatibilityStrategy;
...
import static org.java.plus.dag.core.base.mvel2.debug.DebugTools.getOperatorSymbol;
import static org.java.plus.dag.core.base.mvel2.math.MathProcessor.doOperations;
            ...
            default:
                ...
                if (!leftIsAssignableFromRight && !rightIsAssignableFromLeft) {
                    ...
                    final boolean requiresConversion = right.getEgressType() == String.class || (
                        right.getEgressType() == Double.class && (left.getEgressType() == Float.class
                            || left.getEgressType() == float.class));

                    if (right.isLiteral() && requiresConversion && canConvert(left.getEgressType(),
                        right.getEgressType())) {
