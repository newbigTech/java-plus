...
public class IndexedOperativeAssign extends ASTNode {
    ...
    public IndexedOperativeAssign(char[] expr, int start, int offset, int operation, int register, int fields,
                                  ParserContext pCtx) {
        super(pCtx);
    ...
    public Object getReducedValueAccelerated(Object ctx, Object thisValue, VariableResolverFactory factory) {
        ...
        resolver.setValue(ctx = MathProcessor
            .doOperations(resolver.getValue(), operation, statement.getValue(ctx, thisValue, factory)));
        return ctx;
    }
