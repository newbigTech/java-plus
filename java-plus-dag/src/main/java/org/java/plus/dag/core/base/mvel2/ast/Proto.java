...
import org.java.plus.dag.core.base.mvel2.UnresolveablePropertyException;
...
import org.java.plus.dag.core.base.mvel2.util.CallableProxy;
import org.java.plus.dag.core.base.mvel2.util.SimpleIndexHashMapWrapper;
    ...
    public class ProtoContextFactory extends MapVariableResolverFactory {
        ...
        public VariableResolver createVariable(String name, Object value, Class<?> type) {
            ...
            if (vr != null && vr.getType() != null) {
                throw new CompileException("variable already defined within scope: " + vr.getType() + " " + name, expr,
                    start);
            } else {
