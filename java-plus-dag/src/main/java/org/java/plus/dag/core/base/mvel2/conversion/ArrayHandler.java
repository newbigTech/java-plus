...
package org.java.plus.dag.core.base.mvel2.conversion;

import org.java.plus.dag.core.base.mvel2.ConversionHandler;
...
public class ArrayHandler implements ConversionHandler {
    ...
    private static Object handleLooseTypeConversion(Class sourceType, Object input, Class targetType) {
        ...
        if (!input.getClass().isArray()) {
            // if the input isn't an array converts it in an array with lenght = 1 having has its single item the
            // input itself
