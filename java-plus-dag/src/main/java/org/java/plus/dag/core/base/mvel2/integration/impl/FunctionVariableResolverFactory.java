...
public class FunctionVariableResolverFactory extends BaseVariableResolverFactory
    ...
    public FunctionVariableResolverFactory(Function function, VariableResolverFactory nextFactory,
                                           String[] indexedVariables, Object[] parameters) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            //     variableResolvers.put(indexedVariableNames[i], this.indexedVariableResolvers[i] = new
