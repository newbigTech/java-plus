 ...
 */
package org.java.plus.dag.core.base.mvel2.compiler;

import org.java.plus.dag.core.base.mvel2.CompileException;
import org.java.plus.dag.core.base.mvel2.ErrorDetail;
import org.java.plus.dag.core.base.mvel2.Operator;
import org.java.plus.dag.core.base.mvel2.ParserContext;
import org.java.plus.dag.core.base.mvel2.ast.ASTNode;
import org.java.plus.dag.core.base.mvel2.ast.AssertNode;
import org.java.plus.dag.core.base.mvel2.ast.AssignmentNode;
import org.java.plus.dag.core.base.mvel2.ast.BooleanNode;
import org.java.plus.dag.core.base.mvel2.ast.DeclProtoVarNode;
import org.java.plus.dag.core.base.mvel2.ast.DeclTypedVarNode;
import org.java.plus.dag.core.base.mvel2.ast.DeepAssignmentNode;
import org.java.plus.dag.core.base.mvel2.ast.DoNode;
import org.java.plus.dag.core.base.mvel2.ast.DoUntilNode;
import org.java.plus.dag.core.base.mvel2.ast.EndOfStatement;
import org.java.plus.dag.core.base.mvel2.ast.Fold;
import org.java.plus.dag.core.base.mvel2.ast.ForEachNode;
import org.java.plus.dag.core.base.mvel2.ast.ForNode;
import org.java.plus.dag.core.base.mvel2.ast.Function;
import org.java.plus.dag.core.base.mvel2.ast.IfNode;
import org.java.plus.dag.core.base.mvel2.ast.ImportNode;
import org.java.plus.dag.core.base.mvel2.ast.IndexedAssignmentNode;
import org.java.plus.dag.core.base.mvel2.ast.IndexedDeclTypedVarNode;
import org.java.plus.dag.core.base.mvel2.ast.IndexedOperativeAssign;
import org.java.plus.dag.core.base.mvel2.ast.IndexedPostFixDecNode;
import org.java.plus.dag.core.base.mvel2.ast.IndexedPostFixIncNode;
import org.java.plus.dag.core.base.mvel2.ast.IndexedPreFixDecNode;
import org.java.plus.dag.core.base.mvel2.ast.IndexedPreFixIncNode;
import org.java.plus.dag.core.base.mvel2.ast.InlineCollectionNode;
import org.java.plus.dag.core.base.mvel2.ast.InterceptorWrapper;
import org.java.plus.dag.core.base.mvel2.ast.Invert;
import org.java.plus.dag.core.base.mvel2.ast.IsDef;
import org.java.plus.dag.core.base.mvel2.ast.LineLabel;
import org.java.plus.dag.core.base.mvel2.ast.LiteralDeepPropertyNode;
import org.java.plus.dag.core.base.mvel2.ast.LiteralNode;
import org.java.plus.dag.core.base.mvel2.ast.Negation;
import org.java.plus.dag.core.base.mvel2.ast.NewObjectNode;
import org.java.plus.dag.core.base.mvel2.ast.NewObjectPrototype;
import org.java.plus.dag.core.base.mvel2.ast.NewPrototypeNode;
import org.java.plus.dag.core.base.mvel2.ast.OperativeAssign;
import org.java.plus.dag.core.base.mvel2.ast.OperatorNode;
import org.java.plus.dag.core.base.mvel2.ast.PostFixDecNode;
import org.java.plus.dag.core.base.mvel2.ast.PostFixIncNode;
import org.java.plus.dag.core.base.mvel2.ast.PreFixDecNode;
import org.java.plus.dag.core.base.mvel2.ast.PreFixIncNode;
import org.java.plus.dag.core.base.mvel2.ast.Proto;
import org.java.plus.dag.core.base.mvel2.ast.ProtoVarNode;
import org.java.plus.dag.core.base.mvel2.ast.RedundantCodeException;
import org.java.plus.dag.core.base.mvel2.ast.RegExMatch;
import org.java.plus.dag.core.base.mvel2.ast.ReturnNode;
import org.java.plus.dag.core.base.mvel2.ast.Sign;
import org.java.plus.dag.core.base.mvel2.ast.Stacklang;
import org.java.plus.dag.core.base.mvel2.ast.StaticImportNode;
import org.java.plus.dag.core.base.mvel2.ast.Substatement;
import org.java.plus.dag.core.base.mvel2.ast.ThisWithNode;
import org.java.plus.dag.core.base.mvel2.ast.TypeCast;
import org.java.plus.dag.core.base.mvel2.ast.TypeDescriptor;
import org.java.plus.dag.core.base.mvel2.ast.TypedVarNode;
import org.java.plus.dag.core.base.mvel2.ast.Union;
import org.java.plus.dag.core.base.mvel2.ast.UntilNode;
import org.java.plus.dag.core.base.mvel2.ast.WhileNode;
import org.java.plus.dag.core.base.mvel2.ast.WithNode;
import org.java.plus.dag.core.base.mvel2.integration.VariableResolverFactory;
import org.java.plus.dag.core.base.mvel2.util.ErrorUtil;
import org.java.plus.dag.core.base.mvel2.util.ExecutionStack;
import org.java.plus.dag.core.base.mvel2.util.FunctionParser;
import org.java.plus.dag.core.base.mvel2.util.ProtoParser;

import java.io.Serializable;
import java.util.HashMap;
import java.util.WeakHashMap;

import static org.java.plus.dag.core.base.mvel2.Operator.ADD;
import static org.java.plus.dag.core.base.mvel2.Operator.AND;
import static org.java.plus.dag.core.base.mvel2.Operator.ASSERT;
import static org.java.plus.dag.core.base.mvel2.Operator.ASSIGN;
import static org.java.plus.dag.core.base.mvel2.Operator.ASSIGN_ADD;
import static org.java.plus.dag.core.base.mvel2.Operator.ASSIGN_DIV;
import static org.java.plus.dag.core.base.mvel2.Operator.ASSIGN_MOD;
import static org.java.plus.dag.core.base.mvel2.Operator.ASSIGN_SUB;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_AND;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_OR;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_SHIFT_LEFT;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_SHIFT_RIGHT;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_USHIFT_LEFT;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_USHIFT_RIGHT;
import static org.java.plus.dag.core.base.mvel2.Operator.BW_XOR;
import static org.java.plus.dag.core.base.mvel2.Operator.CHOR;
import static org.java.plus.dag.core.base.mvel2.Operator.CONTAINS;
import static org.java.plus.dag.core.base.mvel2.Operator.CONVERTABLE_TO;
import static org.java.plus.dag.core.base.mvel2.Operator.DEC;
import static org.java.plus.dag.core.base.mvel2.Operator.DIV;
import static org.java.plus.dag.core.base.mvel2.Operator.DO;
import static org.java.plus.dag.core.base.mvel2.Operator.ELSE;
import static org.java.plus.dag.core.base.mvel2.Operator.END_OF_STMT;
import static org.java.plus.dag.core.base.mvel2.Operator.EQUAL;
import static org.java.plus.dag.core.base.mvel2.Operator.FOR;
import static org.java.plus.dag.core.base.mvel2.Operator.FOREACH;
import static org.java.plus.dag.core.base.mvel2.Operator.FUNCTION;
import static org.java.plus.dag.core.base.mvel2.Operator.GETHAN;
import static org.java.plus.dag.core.base.mvel2.Operator.GTHAN;
import static org.java.plus.dag.core.base.mvel2.Operator.IF;
import static org.java.plus.dag.core.base.mvel2.Operator.IMPORT;
import static org.java.plus.dag.core.base.mvel2.Operator.IMPORT_STATIC;
import static org.java.plus.dag.core.base.mvel2.Operator.INC;
import static org.java.plus.dag.core.base.mvel2.Operator.INSTANCEOF;
import static org.java.plus.dag.core.base.mvel2.Operator.ISDEF;
import static org.java.plus.dag.core.base.mvel2.Operator.LETHAN;
import static org.java.plus.dag.core.base.mvel2.Operator.LTHAN;
import static org.java.plus.dag.core.base.mvel2.Operator.MOD;
import static org.java.plus.dag.core.base.mvel2.Operator.MULT;
import static org.java.plus.dag.core.base.mvel2.Operator.NEQUAL;
import static org.java.plus.dag.core.base.mvel2.Operator.NEW;
import static org.java.plus.dag.core.base.mvel2.Operator.OR;
import static org.java.plus.dag.core.base.mvel2.Operator.POWER;
import static org.java.plus.dag.core.base.mvel2.Operator.PROJECTION;
import static org.java.plus.dag.core.base.mvel2.Operator.PROTO;
import static org.java.plus.dag.core.base.mvel2.Operator.PTABLE;
import static org.java.plus.dag.core.base.mvel2.Operator.REGEX;
import static org.java.plus.dag.core.base.mvel2.Operator.RETURN;
import static org.java.plus.dag.core.base.mvel2.Operator.SIMILARITY;
import static org.java.plus.dag.core.base.mvel2.Operator.SOUNDEX;
import static org.java.plus.dag.core.base.mvel2.Operator.STACKLANG;
import static org.java.plus.dag.core.base.mvel2.Operator.STR_APPEND;
import static org.java.plus.dag.core.base.mvel2.Operator.SUB;
import static org.java.plus.dag.core.base.mvel2.Operator.SWITCH;
import static org.java.plus.dag.core.base.mvel2.Operator.TERNARY;
import static org.java.plus.dag.core.base.mvel2.Operator.TERNARY_ELSE;
import static org.java.plus.dag.core.base.mvel2.Operator.UNTIL;
import static org.java.plus.dag.core.base.mvel2.Operator.UNTYPED_VAR;
import static org.java.plus.dag.core.base.mvel2.Operator.WHILE;
import static org.java.plus.dag.core.base.mvel2.Operator.WITH;
import static org.java.plus.dag.core.base.mvel2.ast.TypeDescriptor.getClassReference;
import static org.java.plus.dag.core.base.mvel2.util.ArrayTools.findFirst;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools
    .balancedCaptureWithLineAccounting;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.captureStringLiteral;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.containsCheck;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.createStringTrimmed;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.handleStringEscapes;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isArrayType;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isDigit;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isIdentifierPart;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools
    .isNotValidNameorLabel;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isPropertyOnly;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isReservedWord;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.isWhitespace;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.opLookup;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.similarity;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.subset;
import static org.java.plus.dag.core.base.mvel2.util.PropertyTools.isEmpty;
import static org.java.plus.dag.core.base.mvel2.util.Soundex.soundex;
...
public class AbstractParser implements Parser, Serializable {
    ...
    protected ASTNode nextToken() {
        try {
                        ...
                        switch (OPERATORS.get(t)) {
                            case NEW:
                                ...
                                if (pCtx.getFunctions().containsKey(descr.getClassName())) {
                                    return lastNode = new NewObjectPrototype(pCtx,
                                        pCtx.getFunction(descr.getClassName()));
                                }
                            ...
                            case IMPORT_STATIC:
                                st = cursor = trimRight(cursor);
                                captureToEOS();
                                StaticImportNode staticImportNode = new StaticImportNode(expr, st,
                                    ...
                                    if (cursor != end && expr[cursor] == '=') {
                                        ...
                                        if (pCtx != null && (idx = pCtx.variableIndexOf(name)) != -1) {
                                            splitAccumulator.add(
                                                lastNode = new IndexedDeclTypedVarNode(idx, st, end - st, Object.class,
                                                    pCtx));
                                        } else {
                                            splitAccumulator.add(
                                                lastNode = new DeclTypedVarNode(name, expr, st, end - st, Object.class,
                                                    fields, pCtx));
                                        }
                                    }

                                    if (cursor == this.end || expr[cursor] != ',') { break; } else {
                                        cursor++;
                                        skipWhitespace();
                                        st = cursor;
                                    }
                        ...
                        switch (expr[cursor]) {
                            ...
                            case '~':
                                if (lookAhead() == '=') {
                                    ...
                                    return lastNode = new RegExMatch(expr, tmpStart, tmpOffset, fields, st, cursor - st,
                                        pCtx);
                                }
                                break CaptureLoop;
                            ...
                            case '=':
                                if (lookAhead() == '+') {
                                    ...
                                    if (!isNextIdentifierOrLiteral()) {
                                        throw new CompileException("unexpected symbol '" + expr[cursor] + "'", expr,
                                            st);
                                    }
                        ...
                        case '(': {
                                ...
                                switch (expr[cursor]) {
                                    ...
                                    case 'i':
                                        if (brace == 1 && isWhitespace(lookBehind()) && lookAhead() == 'n'
                                            ...
                                            throw new CompileException(
                                                "unterminated projection; closing parathesis required",
                                                expr, st);
                                        }
                                        break;
                                ...
                                try {
                                    if (tDescr.isClass() && (cls = getClassReference(pCtx, tDescr)) != null) {
                                        ...
                                        for (int i = cursor; i < expr.length; i++) {
                                            ...
                                            isCast = isIdentifierPart(expr[i]) || expr[i] == '\'' || expr[i] == '"'
                                                || expr[i] == '(';
                                            break;
                                        }
                            ...
                            if (tmpStart != -1) {
                                return handleUnion(handleSubstatement(
                                    new Substatement(expr, tmpStart, cursor - tmpStart, fields, pCtx)));
                            } else {
                                return handleUnion(
                                    handleSubstatement(
            ...
            if (st == cursor) { return null; } else { return createPropertyToken(st, cursor); }
        ...
        while (true) {
            ...
            // this redundant looking code is needed to work with the interpreter and MVELSH properly.
                ...
                if (stk.peek() instanceof Class) {
                    ...
                    if (decl) {
                        splitAccumulator.add(
                            new DeclTypedVarNode(new String(expr, st, cursor - st), expr, st, cursor - st,
                    ...
                    throw new CompileException("unknown class or illegal statement: " + lastNode.getLiteralValue(),
                        expr, cursor);
                }
            } else {
                throw new CompileException("unknown class or illegal statement: " + lastNode.getLiteralValue(), expr,
                    cursor);
            }
    ...
    private ASTNode _captureBlock(ASTNode node, final char[] expr, boolean cond, int type) {
        ...
        switch (type) {
            case FUNCTION: {
                ...
                FunctionParser parser = new FunctionParser(name, cursor, end - cursor, expr, fields, pCtx,
                    splitAccumulator);
    ...
    protected boolean tokenContinues() {
        if (cursor == end) { return false; } else if (expr[cursor] == '.' || expr[cursor] == '[') {
            return true;
    ...
    protected void expectEOS() {
        ...
        if (cursor != end && expr[cursor] != ';') {
            switch (expr[cursor]) {
                case '&':
                    if (lookAhead() == '&') { return; } else { break; }
                case '|':
                    if (lookAhead() == '|') { return; } else { break; }
                case '!':
                    if (lookAhead() == '=') { return; } else { break; }
        ...
        if (expression != null && expression.length() != 0) {
            synchronized (EX_PRECACHE) {
                if ((this.expr = EX_PRECACHE.get(expression)) == null) {
                    ...
                    for (int i = 0; i != e.length; i++) { e[i] = expr[i]; }
    ...
    protected char lookBehind() {
        if (cursor == start) { return 0; } else { return expr[cursor - 1]; }
    }
    ...
    protected char lookAhead(int range) {
        if ((cursor + range) >= end) { return 0; } else {
                ...
                while (true) {
                    ...
                    if ((tk = nextToken()) != null && (operator2 = tk.getOperator()) != -1
                        ...
                        if (PTABLE[operator2] == PTABLE[operator]) {
                            if (!dStack.isEmpty()) { dreduce(); } else {
                    ...
                    if ((tk = nextToken()) != null) {
                        switch (operator) {
                            case AND: {
                                if (!(stk.peekBoolean())) { return OP_TERMINATE; } else {
    ...
    protected void reduce() {
        ...
        try {
            switch (operator = (Integer)stk.pop()) {
                ...
                case CONVERTABLE_TO:
                    stk.push(org.java.plus.dag.core.base.mvel2.DataConversion
                        .canConvert(stk.peek2().getClass(), (Class)stk.pop2()));
                    break;
                ...
                case SOUNDEX:
                    stk.push(soundex(String.valueOf(stk.pop()))
                        .equals(soundex(String.valueOf(stk.pop()))));
                    break;
