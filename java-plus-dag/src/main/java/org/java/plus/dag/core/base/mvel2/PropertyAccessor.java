...
import org.java.plus.dag.core.base.mvel2.ast.InvokationContextFactory;
import org.java.plus.dag.core.base.mvel2.ast.Proto;
import org.java.plus.dag.core.base.mvel2.ast.PrototypalFunctionInstance;
...
import org.java.plus.dag.core.base.mvel2.integration.impl.ImmutableDefaultFactory;
...
import static org.java.plus.dag.core.base.mvel2.compiler.AbstractParser.LITERALS;
...
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.findAbsoluteLast;
...
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.parseWithExpressions;
...
public class PropertyAccessor {
    ...
    static {
        READ_PROPERTY_RESOLVER_CACHE = Collections.synchronizedMap(
            new WeakHashMap<Class, WeakHashMap<Integer, WeakReference<Member>>>(10));
        WRITE_PROPERTY_RESOLVER_CACHE = Collections.synchronizedMap(
            new WeakHashMap<Class, WeakHashMap<Integer, WeakReference<Member>>>(10));
        METHOD_RESOLVER_CACHE = Collections.synchronizedMap(
            new WeakHashMap<Class, WeakHashMap<Integer, WeakReference<Object[]>>>(10));
    ...
    public PropertyAccessor(char[] property, int start, int offset, Object ctx, VariableResolverFactory resolver,
                            Object thisReference, ParserContext pCtx) {
    ...
    public static Object get(char[] property, int offset, int end, Object ctx, VariableResolverFactory resolver,
                             Object thisReferece, ParserContext pCtx) {
    ...
    private Object get() {
        ...
        try {
            ...
            throw new PropertyAccessException("null pointer exception in property: " + new String(property), property,
                cursor, e, pCtx);
        } catch (Exception e) {
            throw new PropertyAccessException("unknown exception in expression: " + new String(property), property,
                cursor, e, pCtx);
        }
    }
        ...
        try {
            ...
            if ((curr = get()) == null) {
                throw new PropertyAccessException(
                    "cannot bind to null context: " + new String(property, cursor, length), property, cursor, pCtx);
            }
            ...
            if (member == null) {
                addWriteCache(curr.getClass(), tk != null ? tk.hashCode() : -1,
                    (member = value != null ? getFieldOrWriteAccessor(curr.getClass(), tk, value.getClass())
                        : getFieldOrWriteAccessor(curr.getClass(), tk)));
            }
    ...
    public static void reportCacheSizes() {
        ...
        //  System.out.println(" [" + cls.getName() + "]: " + READ_PROPERTY_RESOLVER_CACHE.get(cls).size() + "
        // entries.");
        //}
        ...
        //  System.out.println(" [" + cls.getName() + "]: " + WRITE_PROPERTY_RESOLVER_CACHE.get(cls).size() + "
        // entries.");
        //}
    ...
    private Object getBeanProperty(Object ctx, String property)
        ...
        if (ctx != null) {
            ...
            if (member instanceof Method) {
                    ...
                    if (member.getDeclaringClass().equals(ctx)) {
                        try {
                            ...
                            throw new CompileException("name collision between innerclass: " + c.getCanonicalName()
                                + "; and bean accessor: " + property + " (" + member.toString() + ")", this.property,
                                this.st);
                ...
                if (ctx instanceof Proto.ProtoInstance) {
                    return ((Proto.ProtoInstance)ctx).get(property).call(null, thisReference, variableFactory,
                        EMPTY_OBJ_ARR);
                }
        ...
        if (tryStatic != null) {
            if (tryStatic instanceof Class || tryStatic instanceof Method) { return tryStatic; } else {
        ...
        if (ctx == null) {
            ...
            throw new PropertyAccessException(
                "could not access: " + property + "; in class: " + ctx.getClass().getName(), this.property, st, pCtx);
        }
    }
    ...
    private Object getCollectionProperty(Object ctx, String prop) throws Exception {
        ...
        if (ctx instanceof Map) {
            ...
            if (count > ((Collection)ctx).size()) {
                throw new PropertyAccessException("index [" + count + "] out of bounds on collections", property,
                    cursor, pCtx);
            }
            ...
            try {
                ...
                throw new PropertyAccessException("illegal use of []: unknown type: " + (ctx.getClass().getName()),
                    property, st, e, pCtx);
            }
        }
    }
    ...
    private Object getMethod(Object ctx, String name) {
        ...
        if (ctx instanceof PrototypalFunctionInstance) {
            ...
            if (prop instanceof PrototypalFunctionInstance) {
                return ((PrototypalFunctionInstance)prop).call(ctx, thisReference,
                    new InvokationContextFactory(variableFactory, funcCtx), args);
            }
        }
