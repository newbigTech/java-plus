 ...
 * are obtained via a
 * {@link org.java.plus.dag.core.base.mvel2.integration.VariableResolverFactory}.
 */
public interface VariableResolver extends Serializable {
     ...
     * only of benefit to systems that require use of MVEL's strict typing facilities.  In most cases, this
     * implementation
