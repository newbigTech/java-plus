...
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.findInnerClass;
import static org.java.plus.dag.core.base.mvel2.util.ParseTools.forNameWithInner;
        ...
        try {
            ...
            for (int i = end - 1; i > start; i--) {
                switch (expr[i]) {
                    case '.':
                        if (!meth) {
                            ClassLoader classLoader = pCtx != null ? pCtx.getClassLoader()
