...
public class CompiledEvalNode extends Node {
    ...
    public Object eval(TemplateRuntime runtime, TemplateOutputStream appender, Object ctx,
        ...
        appender.append(
            String.valueOf(TemplateRuntime.eval(valueOf(MVEL.executeExpression(ce, ctx, factory)), ctx, factory)));
    ...
    public String toString() {
        return "EvalNode:" + name + "{" + (contents == null ? "" : new String(contents)) + "} (start=" + begin + ";end="
            + end + ")";
    }
}