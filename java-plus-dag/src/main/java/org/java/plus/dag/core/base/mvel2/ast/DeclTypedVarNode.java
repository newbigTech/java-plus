...
public class DeclTypedVarNode extends ASTNode implements Assignment {
    ...
    public DeclTypedVarNode(String name, char[] expr, int start, int offset, Class type, int fields,
                            ParserContext pCtx) {
        super(pCtx);
    ...
    public Object getReducedValueAccelerated(Object ctx, Object thisValue, VariableResolverFactory factory) {
        if (!factory.isResolveable(name)) { factory.createVariable(name, null, egressType); } else {
            throw new CompileException("variable defined within scope: " + name, expr, start);
        }
        return null;
    }
