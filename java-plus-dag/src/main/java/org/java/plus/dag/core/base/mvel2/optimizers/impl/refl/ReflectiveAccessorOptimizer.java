 ...
 */
package org.java.plus.dag.core.base.mvel2.optimizers.impl.refl;
...
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.collection
    .ArrayCreator;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.collection
    .ExprValueAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.collection.ListCreator;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.collection.MapCreator;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.ArrayAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes
    .ArrayAccessorNest;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.ArrayLength;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes
    .ConstructorAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes
...
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.FieldAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.FieldAccessorNH;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.FunctionAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.GetterAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.GetterAccessorNH;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes
...
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.ListAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.ListAccessorNest;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.MapAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.MapAccessorNest;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.MethodAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.MethodAccessorNH;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.Notify;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.NullSafe;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes
    .PropertyHandlerAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.SetterAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes
...
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.VariableAccessor;
import org.java.plus.dag.core.base.mvel2.optimizers.impl.refl.nodes.WithAccessor;
import org.java.plus.dag.core.base.mvel2.util.ArrayTools;
import org.java.plus.dag.core.base.mvel2.util.ErrorUtil;
import org.java.plus.dag.core.base.mvel2.util.MethodStub;
import org.java.plus.dag.core.base.mvel2.util.NullType;
...
public class ReflectiveAccessorOptimizer extends AbstractOptimizer implements AccessorOptimizer {
    ...
    public Accessor optimizeAccessor(ParserContext pCtx, char[] property, int start, int offset, Object ctx,
                                     Object thisRef,
    ...
    public Accessor optimizeSetAccessor(ParserContext pCtx, char[] property, int start, int offset, Object ctx,
        ...
        if (ctx == null) {
            throw new PropertyAccessException(
                "could not access property: " + new String(property, this.start, Math.min(length, property.length))
                    + "; parent is null: "
        ...
        try {
            ...
            throw new PropertyAccessException(
                "error binding property: " + new String(property) + " (value <<" + value + ">>::"
    ...
    private void addAccessorNode(AccessorNode an) {
        if (rootNode == null) { rootNode = currNode = an; } else {
                    ...
                    if (property.equals(m.getName())) {
                        if (pCtx != null && pCtx.getParserConfiguration() != null ? pCtx.getParserConfiguration()
                            ...
                            if (hasNullMethodHandler()) {
                                addAccessorNode(
                                    new MethodAccessorNH(m, new ExecutableStatement[0], getNullMethodHandler()));
                                if (o == null) {
    ...
    @SuppressWarnings("unchecked")
    private Object getMethod(Object ctx, String name, Object[] args, Class[] argTypes, ExecutableStatement[] es)
        throws Exception {
        ...
        Object o = ctx != null ? method.invoke(ctx, normalizeArgsForVarArgs(parameterTypes, args, m.isVarArgs()))
            : null;
    ...
    private AccessorNode compileConstructor(char[] expression, Object ctx, VariableResolverFactory vars) throws
        ...
        if (constructorParms != null) {
            ...
            if (cnsRes.length > 1) {
                ...
                ReflectiveAccessorOptimizer compiledOptimizer
                    = new ReflectiveAccessorOptimizer(pCtx, cnsRes[1].toCharArray(), 0, cnsRes[1].length(),
                    cns.newInstance(array), ctx, vars);
                compiledOptimizer.setRootNode(ca);
                compiledOptimizer.compileGetChain();
                ca = compiledOptimizer.getRootNode();
